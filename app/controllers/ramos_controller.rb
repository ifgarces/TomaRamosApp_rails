...
public
    def inscribe_ramo_for_user()
        raise NotImplementedError
    end

    def uninscribe_ramo_for_user()
        raise NotImplementedError
    end
...
private
    ...
    def ramo_params
        params.require(:ramo).permit(:nrc, :name, :profesor, :creditos, :materia, :curso, :seccion, :plan_estudios, :conect_liga, :lista_cruzada)
    end
end
