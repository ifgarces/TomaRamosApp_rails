...
class CsvRowTest < ActiveSupport::TestCase
  ...
  def assertEqualCsvRows(expectedRow, gotRow)
    ...
    assert_equal(expectedRow.pe, gotRow.pe)
    assert_equal(expectedRow.nrc, gotRow.nrc)
    assert_equal(expectedRow.conectorLiga, gotRow.conectorLiga)
    assert_equal(expectedRow.listaCruzada, gotRow.listaCruzada)
    ...
    assert_equal(expectedRow.créditos, gotRow.créditos)
    ...
    assert_equal(expectedRow.fechaInicio, gotRow.fechaInicio)
    assert_equal(expectedRow.fechaFin, gotRow.fechaFin)
    assert_equal(expectedRow.sala, gotRow.sala)
